...
import PostSave from "../../common-components/post-components/PostSave";
	...
	return (
		<CardContent className={classes.cardContent}>
			...
			<div className={classes.postInteractions}>
				...
				{/* Post save ability */}
				<PostSave post={post} docId={docId} user={user} />
			</div>

			{/* Post Content */}
			<PostCaption user={user} username={user.username} caption={caption} />
			...
			{commentsCount == 0 ? (
				...
				<Typography
					...
					color="textSecondary"
				>
					{showComments ? "Hide" : "Show"} all {commentsCount} comments
				</Typography>
			)}

			{/* All comments */}
			<Collapse in={showComments}>
				<PostComments fullScreen={false} borders={false} comments={comments} />
			</Collapse>
		</CardContent>
	);
}
