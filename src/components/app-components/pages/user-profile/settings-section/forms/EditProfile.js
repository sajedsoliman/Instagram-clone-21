...
function EditProfile() {
	...
	const userNameSide = (
		<div>
			...
			<Typography onClick={handleModalOpen} className={classes.changeImage} color="primary">
	...
	return (
		<Form onSubmit={handleSubmitForm}>
			...
			/>
			{/* Bio group */}
			<RowFormGroup label="Bio" multi={true} controlProps={inputCommonProps("", "bio", user.bio)} />
			{/* Website group */}
			<RowFormGroup
				label="Website"
