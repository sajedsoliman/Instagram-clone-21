...
function PostCardHeader({ creatorInfo, location, handleOpenModal }) {
    ...
    // card header props
    const headerProps = {
        avatar: <div onMouseLeave={closeProfileOverviewAvatar}>
            <Avatar
        ...
        title: <div onMouseLeave={closeProfileOverviewTitle}>
            <RouterLink onMouseOver={showProfileOverviewTitle} className={classes.profileLink} to={`/${username}`}>{fullName}</RouterLink>
